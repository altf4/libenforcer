...
import {Coord, SlippiGame, getCoordListFromGame, hasDisallowedCStickCoords, toArrayBuffer} from '../index';
...
test('Should pass check for disallowed C-Stick values', () => {
    ...
    const result = hasDisallowedCStickCoords(null, 0, coords).result
