...
test('Is box inputs? Orca dataset A', () => {
    let data = fs.readFileSync(path.join(__dirname, '../../test_data/legal/analog/orca/Game_20241228T175942.slp'), null);
    let game = new SlippiGame(toArrayBuffer(data))
    expect(game).not.toBeNull()
...
test('Is box inputs? Orca dataset B', () => {
    let data = fs.readFileSync(path.join(__dirname, '../../test_data/legal/analog/orca/Game_20241228T180350.slp'), null);
    let game = new SlippiGame(toArrayBuffer(data))
    expect(game).not.toBeNull()
    let gameCoords: Coord[] = getCoordListFromGame(game, 0, true)
    expect(isBoxController(gameCoords)).toEqual(false)
...
test('Is box inputs? Orca dataset C', () => {
    let data = fs.readFileSync(path.join(__dirname, '../../test_data/legal/analog/orca/Game_20241228T180707.slp'), null);
    let game = new SlippiGame(toArrayBuffer(data))
    expect(game).not.toBeNull()
    let gameCoords: Coord[] = getCoordListFromGame(game, 0, true)
    expect(isBoxController(gameCoords)).toEqual(false)
...
test('Is box inputs? Orca dataset D', () => {
    let data = fs.readFileSync(path.join(__dirname, '../../test_data/legal/analog/orca/Game_20241228T180831.slp'), null);
    let game = new SlippiGame(toArrayBuffer(data))
    expect(game).not.toBeNull()
    let gameCoords: Coord[] = getCoordListFromGame(game, 0, true)
    expect(isBoxController(gameCoords)).toEqual(false)
...
test('Is box inputs? Orca dataset E', () => {
    let data = fs.readFileSync(path.join(__dirname, '../../test_data/legal/analog/orca/Game_20241228T181133.slp'), null);
    let game = new SlippiGame(toArrayBuffer(data))
    expect(game).not.toBeNull()
    let gameCoords: Coord[] = getCoordListFromGame(game, 0, true)
    expect(isBoxController(gameCoords)).toEqual(false)
